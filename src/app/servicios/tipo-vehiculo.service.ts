...
import { TipooVehiculoEnum } from '../modelo/enum/tipo-vehiculo-enum';
...
export class TipoVehiculoService {
  ...
  listarTodos(): string[] {
    let objetos:string[]=[];
    for(let objeto in TipooVehiculoEnum){
      objetos.push(TipooVehiculoEnum[objeto] as string)
    }
    return objetos;
  }
